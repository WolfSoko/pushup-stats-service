...
describe('push/reminder-action', () => {
  ...
  describe('parseReminderActionRequest', () => {
    ...
    it('should reject a snooze from a reminder sent before it was retired', () => {
      // given a notification still carrying the old snooze button
      const parsed = parseReminderActionRequest({
        uid: 'u',
        token: 't',
        action: 'snooze',
      ...
      // then it is refused rather than honoured against logic that is gone
