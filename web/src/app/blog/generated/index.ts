...
import { POST as p30 } from './pieseis-ges-kardia-melete.grc';
...
import { POST as p38 } from './wim-hof-pushups.en';
import { POST as p39 } from './flexiones-mayores-40.es';
import { POST as p40 } from './liegestuetze-ab-40.de';
import { POST as p41 } from './opdrukken-na-40.nl';
import { POST as p42 } from './piegamenti-dopo-i-40.it';
import { POST as p43 } from './pieseis-ges-meta-tessarakonta.grc';
import { POST as p44 } from './pompes-apres-40-ans.fr';
import { POST as p45 } from './pressiones-post-xl-annos.la';
import { POST as p46 } from './pushups-over-40.en';
import { POST as p47 } from './30-dagen-opdruk-challenge.nl';
import { POST as p48 } from './30-day-pushup-challenge.en';
import { POST as p49 } from './30-tage-liegestuetze-challenge.de';
import { POST as p50 } from './defi-pompes-30-jours.fr';
import { POST as p51 } from './desafio-flexiones-30-dias.es';
import { POST as p52 } from './provocatio-triginta-dierum.la';
import { POST as p53 } from './sfida-30-giorni-piegamenti.it';
