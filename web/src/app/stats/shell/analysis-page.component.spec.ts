...
describe('AnalysisPageComponent', () => {
  ...
  const apiMock = {
    listPushups: jest.fn().mockReturnValue(
      of([
        { _id: '1', timestamp: '2026-02-09T08:00:00', reps: 10, source: 'wa' }, // So
        { _id: '2', timestamp: '2026-02-10T08:00:00', reps: 12, source: 'web' }, // Mo
        { _id: '3', timestamp: '2026-02-11T08:00:00', reps: 20, source: 'wa' }, // Di
        { _id: '4', timestamp: '2026-02-12T08:00:00', reps: 8, source: 'web' }, // Mi
        { _id: '5', timestamp: '2026-02-13T08:00:00', reps: 25, source: 'wa' }, // Do
        { _id: '6', timestamp: '2026-02-15T08:00:00', reps: 18, source: 'web' }, // Sa
      ]),
    ),
  };
  ...
  it('computes streak stats', () => {
    ...
    expect(component.currentStreak()).toBeGreaterThanOrEqual(1);
  });

  it('builds hour-weekday heatmap with 24 hour rows and 7 weekday columns', () => {
    const component = fixture.componentInstance;

    expect(component.heatmap().length).toBe(24);
    expect(component.heatmap()[0]?.weekdays.length).toBe(7);
  });
});
