...
export const EXERCISE_DISPLAY_NAMES: Readonly<Record<string, string>> = {
  ...
  'cardio.hiking': $localize`:@@exercise.cardio.hiking.name:Wandern`,
  'cardio.nordicwalking': $localize`:@@exercise.cardio.nordicwalking.name:Nordic Walking`,
  ...
  'cardio.elliptical': $localize`:@@exercise.cardio.elliptical.name:Crosstrainer`,
  'cardio.inlineskating': $localize`:@@exercise.cardio.inlineskating.name:Inline-Skaten`,
  'cardio.crosscountryskiing': $localize`:@@exercise.cardio.crosscountryskiing.name:Skilanglauf`,
