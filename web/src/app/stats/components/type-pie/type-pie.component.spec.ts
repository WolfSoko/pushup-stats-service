...
describe('TypePieComponent', () => {
  ...
  it('should preselect the top 5 highest-value ids by default', () => {
    // Then
  ...
  it('should sum only the selected types in selectedTotal', () => {
  ...
  it('should render the selected total in the donut center', () => {
  ...
  it('should fill the pie 100% with selected types (sum of dash fractions ≈ 100)', () => {
  ...
  it('should make legend percentages for selected types relative to the selected total', () => {
  ...
  it('should surface a focused slice info in the donut center', () => {
  ...
  it('should clear the focus and restore the total when the same slice is clicked twice', () => {
    component.focusSegment('Standard');
  ...
  it('should focus a slice clicked in the SVG via the (click) handler', () => {
    const host: HTMLElement = fixture.nativeElement;
  ...
  it('should focus a slice via Enter keydown', () => {
    const host: HTMLElement = fixture.nativeElement;
    const slice = host.querySelector(
      '[data-testid="type-pie-slice-Diamond"]'
    ) as SVGElement | null;
  ...
  it('should focus a slice via Space keydown', () => {
    const host: HTMLElement = fixture.nativeElement;
    const slice = host.querySelector(
  ...
  it('should clear the focus when the focused type is toggled off', () => {
    component.focusSegment('Standard');
    expect(component.focusedSegment()?.id).toBe('Standard');
  ...
  it('should not dim slices when the parent swaps data and evicts the focused id', () => {
  ...
  it('should render 0% (not raw count) for a selected slice whose share rounds to zero', () => {
  ...
  it('should remove the type and drop its slice from the pie when a checkbox is toggled', () => {
  ...
  it('should add a previously-hidden type to the visible set when toggled', () => {
  ...
  it('should wire a legend mat-checkbox click through to toggle()', async () => {
  ...
  it('should use the stable id (not the localized label) for selection and test selectors', () => {
  ...
  it('should render one legend row with checkbox per type plus the Top 5 preset', () => {
  ...
  it('should cap the legend container height so the list scrolls when many types are present', () => {
  ...
  it('should show the empty placeholder when total is zero', () => {
  ...
  it('should keep stable colors per index sorted by descending value', () => {
    // Then
  ...
  it('should render a Top 5 preset checkbox at the top of the legend, checked by default', () => {
  ...
  it('should restore exactly the top-5 ids when the Top 5 preset is clicked on a custom subset', () => {
  ...
  it('should expand the selection so selectedTotal equals the grand total when the Top 5 preset is unchecked', () => {
  ...
  it('should toggle selection via the Top 5 preset checkbox harness', async () => {
