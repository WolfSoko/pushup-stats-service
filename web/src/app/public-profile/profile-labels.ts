...
export const PROFILE_LABELS = {
  ...
  workouts: $localize`:@@publicProfile.workouts:Sessions`,
  workoutsCopy: $localize`:@@publicProfile.workouts.copy:Übernehmen`,
  workoutsCopied: $localize`:@@publicProfile.workouts.copied:Übernommen`,
  workoutsOwn: $localize`:@@publicProfile.workouts.own:Zu meinen Sessions`,
  workoutsCopiedNote: $localize`:@@publicProfile.workouts.copiedNote:Gespeichert unter „Meine Sessions“.`,
  workoutsCopyFailed: $localize`:@@publicProfile.workouts.copyFailed:Konnte nicht übernommen werden. Bitte später erneut versuchen.`,
  ...
  xp: $localize`:@@publicProfile.stat.xp:Level & XP`,
  reps: $localize`:@@publicProfile.stat.reps:Wiederholungen gesamt`,
  duration: $localize`:@@publicProfile.stat.duration:Trainingszeit gesamt`,
  distance: $localize`:@@publicProfile.stat.distance:Strecke gesamt`,
  days: $localize`:@@publicProfile.stat.days:Trainingstage`,
  streak: $localize`:@@publicProfile.stat.streak:Tage in Folge`,
  entries: $localize`:@@publicProfile.stat.entries:Einträge gesamt`,
  bestEntry: $localize`:@@publicProfile.stat.bestEntry:Stärkster Eintrag`,
  bestDay: $localize`:@@publicProfile.stat.bestDay:Stärkster Tag`,
