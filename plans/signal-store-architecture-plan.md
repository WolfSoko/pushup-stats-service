...
| ----- | ------------ | ------------------ | --------- | ------ |
| 1     | ads          | `AdsStore`         | root      | Done   |
| 2     | motivation   | `MotivationStore`  | root      | Done   |
| 3     | data-access  | `LiveDataStore`    | root      | Done   |
| 4     | data-access  | `LeaderboardStore` | root      | Done   |
| 5     | web/stats    | `DashboardStore`   | component | Done   |
| 6     | web/analysis | `AnalysisStore`    | component | Done   |
| 7     | web/entries  | `EntriesStore`     | component | Done   |
