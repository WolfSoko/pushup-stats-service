...
<ol>
  <li>
    <strong>Veggarmhevninger:</strong> Hender skulderbredde fra en vegg, føtter en meter bort. Lut deg kontrollert inn, trykk tilbake. Mål: 3×15 rene repetisjonene.
  </li>
  <li>
  ...
  <li>
    <strong>Fulle armhevninger:</strong> Først en, så to, så et lite sett. Tre rene rep betyr at bevegelsen er din.
  </li>
</ol>

<h2>En realistisk 4-ukers startplan</h2>
<p>
  Tre treningsdager per uke (man/ons/fre), 15 minutter hver. Per sesjon, tre sett av dagens trinn pluss en styrkeblokk (planke 3×30s + steiglutealike 3×12).
</p>
<ul>
  <li><strong>Uke 1:</strong> Trinn 1 (vegg). Når 3×15 er rene, gå videre.</li>
  <li><strong>Uke 2:</strong> Trinn 2 (hevet). Velg en høyde som tillater 3×10.</li>
  <li><strong>Uke 3:</strong> Trinn 3 (kne) + ett negativt forsøk ved sesjonsslutting.</li>
  <li><strong>Uke 4:</strong> Trinn 4 (negative) som hovedarbeid, forsøk en fullarmhevning sist.</li>
</ul>
<p>
  Omtrent 70 % av nybegynnere oppnår sin første fulle rep på uke 4–6 med dette systemet. De andre 30 % trenger 8–10 uker — godt innenfor normalområdet.</p>
