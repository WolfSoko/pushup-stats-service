...
const LOCALES = {
  ...
  la: {
    titles: {
      'plan.push-pull-6w.title':
        'Push &amp; Pull Balance — consilium sex hebdomadarum',
      'plan.full-body-6w.title':
        'Full Body Strong — consilium totius corporis sex hebdomadarum',
      'plan.core-4w.title':
        'Core Foundations — consilium medii corporis quattuor hebdomadarum',
      'plan.hiit-4w.title':
        'HIIT Burner — consilium exercitationis quattuor hebdomadarum',
      'plan.mobility-2w.title':
        'Mobility &amp; Recovery — recuperatio duarum hebdomadarum',
    },
    summaries: {
      'plan.push-pull-6w.summary':
        'Consilium symmetricum sex hebdomadarum pro pectoribus et tractibus (remi, tractus negativi, face pulls). Vitat classicum disaequilibrium &quot;solum push&quot; et catenam posteriorem aequaliter roborat. Unus dies tractibus dicatus per hebdomadam praeter progressionem push.',
      'plan.full-body-6w.summary':
        'Sex hebdomades circulorum totius corporis: pectores, genuflexiones, gradus, glute bridges et plank in circulis trium, quattuor et quinque circuitionum. Tres dies exercitationis per hebdomadam, volumen clare crescens, examen functionale in hebdomada sexta.',
      'plan.core-4w.summary':
        'Quattuor hebdomades stabilitatis medii corporis: plank, hollow hold, dead bug, elevationes crurum et opera rotationalia. Quisque dies exercitationis etiam activationem moderatam pectorum continet. Quattuor dies exercitationis et unus dies levis per hebdomadam, examen finale cum tentione plank et hollow hold.',
      'plan.hiit-4w.summary':
        'Quattuor hebdomades intervallorum altae intensitatis cum pectoribus, burpees, mountain climbers, jumping jacks et genuflexionibus. Structurae Tabata, pyramidis et EMOM. Bene operatur ut amplificator exercitationis inter consilia classica pectorum.',
      'plan.mobility-2w.summary':
        'Duae hebdomades recuperationis activae: cotidianae sessiones mobilitatis, yoga et extensionum cum levi volumine pectorum. Optimum ut recuperatio inter duo consilia gravia aut ad reditum post intermissionem.',
    },
    phrases: [
      ['saubere Liegestütze', 'pectores purae'],
      ['Knie-Liegestütze als Aktivierung', 'pectores genuum ut activatio'],
      ['Knie-Liegestütze', 'pectores genuum'],
      ['Hängendes Knieheben', 'elevationes genuum pendentes'],
      ['invertierte Ruderzüge', 'remi inversi'],
      ['Klimmzug-Negative', 'tractus negativi'],
      ['Sumo-Kniebeugen', 'genuflexiones sumo'],
      ['Jump Squats', 'genuflexiones cum saltu'],
      ['Aktive Erholung', 'Recuperatio activa'],
      ['Leichter Tag', 'Dies levis'],
      ['Pull-Tag', 'Dies tractuum'],
      ['Pull-Schwerpunkt', 'Focus tractuum'],
      ['Brust- und Rücken-Mobility', 'mobilitas pectoris et dorsi'],
      ['Brust-Stretching', 'extensio pectoris'],
      ['Schulter-Mobility', 'mobilitas humerorum'],
      ['Hip Opener', 'apertio coxae'],
      ['Dead Bugs', 'dead bugs'],
      ['Dead Bug', 'dead bug'],
      ['Russian Twists', 'torsiones russicae'],
      ['Russian Twist', 'torsio russica'],
      ['Side Plank', 'plank lateralis'],
      ['Wall-Sit', 'sessio ad murum'],
      ['Glute Bridges', 'pontes glutei'],
      ['Hip Thrusts', 'impulsus coxarum'],
      ['Step-Ups', 'ascensus'],
      ['Hollow Hold', 'hollow hold'],
      ['Hollow-Hold-Zeit', 'tempus hollow hold'],
      ['Plank-Halt', 'tentio plank'],
      ['Plank-Zeit', 'tempus plank'],
      ['Mountain Climbers', 'mountain climbers'],
      ['Jumping Jacks', 'jumping jacks'],
      ['Hampelmänner', 'jumping jacks'],
      ['Burpees', 'burpees'],
      ['Squats', 'genuflexiones'],
      ['Kniebeugen', 'genuflexiones'],
      ['Ausfallschritte', 'gradus'],
      ['Liegestützen', 'pectores'],
      ['Liegestütze', 'pectores'],
      ['Klimmzügen', 'tractus'],
      ['Klimmzüge', 'tractus'],
      ['Klimmzug', 'tractus'],
      ['Australian Rows', 'remi australes'],
      ['Face Pulls', 'face pulls'],
      ['Rudern', 'remi'],
      ['Cat-Cow', 'feles-vacca'],
      ['Foam Rolling', 'foam rolling'],
      ['Yoga-Flow', 'yoga flow'],
      ['Dynamisches Aufwärmen', 'Calefactio dynamica'],
      ['lockeres Cardio', 'cardio leve'],
      ['Spaziergang', 'ambulatio'],
      ['Mobility-Session', 'sessio mobilitatis'],
      ['vollständige', 'plena'],
      ['Stretching', 'extensiones'],
      ['Mobility', 'mobilitas'],
      ['Yoga', 'yoga'],
      ['Gehen', 'ambulatio'],
      ['Ruhetag', 'Dies quietis'],
      ['Form-Check', 'examen formae'],
      ['Peak-Zirkel', 'Circulus culminis'],
      ['Taper-Zirkel', 'Circulus deminutionis'],
      ['Taper-Tag', 'Dies deminutionis'],
      ['Core-Power', 'Core potentia'],
      ['Core-Zirkel', 'Circulus medii corporis'],
      ['Baseline-Test', 'Examen referentiae'],
      ['Konditionstest', 'Examen conditionis'],
      ['Funktionstest', 'Examen functionale'],
      ['Endtest', 'Examen finale'],
      ['Baseline', 'Referentia'],
      ['Zirkel', 'Circulus'],
      ['HIIT-Finale', 'Finale HIIT'],
      ['HIIT-Ladder', 'Scala HIIT'],
      ...
      ['Runde', 'circuitio'],
      ['Pause', 'quies'],
      ['Wiederholungen', 'repetitiones'],
      ['Wiederholung', 'repetitio'],
      ['weniger', 'minus'],
      ['Bestzeit notieren', 'optimum tempus nota'],
      ['auf Zeit', 'ad tempus'],
      ['in einem Satz', 'in una serie'],
      ['je Bein', 'pro crure'],
      ['je Seite', 'pro latere'],
      ['pro Minute', 'per minutum'],
      ['jede Runde', 'omni circuitione'],
      ['saubere', 'purae'],
      ['kontrolliertes Tempo', 'tempus moderatum'],
      ['schwer', 'gravis'],
      ['oder Negative', 'aut negativi'],
      ['Ziel', 'finis'],
      ['Exzentrik', 'excentrica'],
      ['nach Bedarf', 'pro necessitate'],
