...
export const EXERCISE_CATALOG: ReadonlyArray<ExerciseDefinition> = [
  ...
  },
  {
    ...
    max: 100_000,
    unit: 'm',
    nameKey: '@@exercise.cardio.hiking.name',
    icon: 'hiking',
  },
  {
    ...
    max: 50_000,
    unit: 'm',
    nameKey: '@@exercise.cardio.nordicwalking.name',
    icon: 'nordic_walking',
  },
  {
    id: 'cardio.cycling',
  ...
  },
  {
    ...
    max: 50_000,
    unit: 'm',
    nameKey: '@@exercise.cardio.elliptical.name',
    icon: 'fitness_center',
  },
  {
    ...
    max: 100_000,
    unit: 'm',
    nameKey: '@@exercise.cardio.inlineskating.name',
    icon: 'roller_skating',
  },
  {
    ...
    max: 100_000,
    unit: 'm',
    nameKey: '@@exercise.cardio.crosscountryskiing.name',
